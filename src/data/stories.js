...
export const STORIES = [
  {
    ...
    lines: [
      ...
      { en: 'Out comes the big turnip!', cn: '大萝卜终于拔出来啦！', e: '🎉', img: '/stories/turnip-7.png' },
    ],
  },
  {
    ...
    lines: [
      ...
      { en: 'The water comes up and up.', cn: '水慢慢升上来。', e: '⬆️', img: '/stories/crow-5.jpg' },
  ...
  },
  {
    ...
    lines: [
      ...
      { en: 'The hare runs very fast.', cn: '兔子跑得飞快。', e: '💨', img: '/stories/tortoise-3.jpg' },
      ...
      { en: 'The tortoise wins the race!', cn: '乌龟赢得了比赛！', e: '🏆', img: '/stories/tortoise-6.jpg' },
      { en: 'Slow and steady wins.', cn: '坚持不懈就能赢。', e: '⭐', img: '/stories/tortoise-7.jpg' },
    ],
  },
  {
    ...
    lines: [
      ...
      { en: '"Please let me go!"', cn: '“请放了我吧！”', e: '🙏', img: '/stories/lion-3.jpg' },
      { en: 'The lion lets the mouse go.', cn: '狮子放走了老鼠。', e: '🦁', img: '/stories/lion-4.jpg' },
      { en: 'One day the lion is trapped.', cn: '有一天狮子被网困住了。', e: '🕸️', img: '/stories/lion-5.jpg' },
      { en: 'The mouse bites the net.', cn: '老鼠咬断了网。', e: '✂️', img: '/stories/lion-6.jpg' },
      { en: 'Now they are good friends.', cn: '他们成了好朋友。', e: '❤️', img: '/stories/lion-7.jpg' },
    ],
  },
  {
    ...
    lines: [
      ...
      { en: 'The second house is sticks.', cn: '第二座是木头房。', e: '🪵', img: '/stories/pigs-3.jpg' },
      { en: 'The third house is bricks.', cn: '第三座是砖头房。', e: '🧱', img: '/stories/pigs-4.jpg' },
      { en: 'A wolf blows the houses down.', cn: '大灰狼吹倒了房子。', e: '🐺', img: '/stories/pigs-5.jpg' },
      { en: 'But the brick house stays strong.', cn: '只有砖房很结实。', e: '💪', img: '/stories/pigs-6.jpg' },
      { en: 'The pigs are safe and happy.', cn: '小猪们安全又开心。', e: '🎉', img: '/stories/pigs-7.jpg' },
    ],
  },
  {
    ...
    lines: [
      ...
      { en: 'The fox jumps again and again.', cn: '狐狸一次又一次地跳。', e: '🦊', img: '/stories/fox-3.jpg' },
      { en: 'But it cannot reach them.', cn: '可是怎么也够不到。', e: '😣', img: '/stories/fox-4.jpg' },
      { en: '"These grapes are sour!"', cn: '“这些葡萄是酸的！”', e: '😤', img: '/stories/fox-5.jpg' },
      { en: 'Then the fox walks away.', cn: '然后狐狸走开了。', e: '🚶', img: '/stories/fox-6.jpg' },
    ],
  },
  {
    ...
    lines: [
      ...
      { en: 'The duckling is sad and alone.', cn: '小鸭又伤心又孤单。', e: '🦆', img: '/stories/duckling-3.jpg' },
      { en: 'Winter comes and goes.', cn: '冬天来了又走了。', e: '❄️', img: '/stories/duckling-4.jpg' },
      { en: 'He grows up by the lake.', cn: '他在湖边长大了。', e: '🌊', img: '/stories/duckling-5.jpg' },
      { en: 'He is a beautiful swan!', cn: '他变成了美丽的天鹅！', e: '🦢', img: '/stories/duckling-6.jpg' },
    ],
  },
  {
    ...
    lines: [
      ...
      { en: 'This is me.', cn: '这是我。', e: '🧒', img: '/stories/family-3.jpg' },
      { en: 'I love my family.', cn: '我爱我的家人。', e: '❤️', img: '/stories/family-4.jpg' },
    ],
  },
];
