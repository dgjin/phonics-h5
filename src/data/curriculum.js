...
export const CURRICULUM = [
  ...
  {
    id: 'k1', title: 'K1', cn: '短元音 & Sight Words', color: 'teal', icon: 'ti-volume',
    desc: '短元音 a / e、字母词族、CVC 拼读，以及 Sight Words 高频词（24词）',
    units: [
      ...
      { id: 'sight-words-1', title: 'Sight Words I', cn: '高频词（第1组）', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'the', s: '/ðə/', w: 'the', e: '📌' },
        { l: 'a', s: '/ə/', w: 'a', e: '🔤' },
        { l: 'is', s: '/ɪz/', w: 'is', e: '➡️' },
        { l: 'on', s: '/ɒn/', w: 'on', e: '⬆️' },
      ...
      { id: 'sight-words-2', title: 'Sight Words II', cn: '高频词（第2组）', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'he', s: '/hiː/', w: 'he', e: '👨' },
        { l: 'she', s: '/ʃiː/', w: 'she', e: '👩' },
        { l: 'we', s: '/wiː/', w: 'we', e: '👥' },
        { l: 'me', s: '/miː/', w: 'me', e: '🙋' },
      ...
      { id: 'sight-words-3', title: 'Sight Words III', cn: '高频词（第3组）', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'and', s: '/ænd/', w: 'and', e: '➕' },
        { l: 'are', s: '/ɑːr/', w: 'are', e: '🔵' },
        { l: 'was', s: '/wɒz/', w: 'was', e: '⏪' },
        { l: 'you', s: '/juː/', w: 'you', e: '👆' },
        { l: 'has', s: '/hæz/', w: 'has', e: '🤲' },
        { l: 'his', s: '/hɪz/', w: 'his', e: '👦' },
        { l: 'her', s: '/hɜːr/', w: 'her', e: '👧' },
        { l: 'they', s: '/ðeɪ/', w: 'they', e: '👨‍👩‍👧' },
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    units: [
      ...
      { id: 'dig-th', title: 'Digraph th (清)', cn: 'th 清辅音 /θ/', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'th', s: '/θ/', w: 'thumb', e: '👍', p: ['th', 'umb'] },
        { l: 'th', s: '/θ/', w: 'three', e: '3️⃣', p: ['th', 'ree'] },
        { l: 'th', s: '/θ/', w: 'bath', e: '🛁', p: ['ba', 'th'] },
        { l: 'th', s: '/θ/', w: 'teeth', e: '🦷', p: ['tee', 'th'] },
        { l: 'th', s: '/θ/', w: 'throw', e: '🎯', p: ['th', 'row'] },
      ]},
      { id: 'voiced-th', title: 'Voiced th (浊)', cn: 'th 浊辅音 /ð/', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'th', s: '/ð/', w: 'this', e: '👈', p: ['th', 'is'] },
        { l: 'th', s: '/ð/', w: 'that', e: '👉', p: ['th', 'at'] },
        { l: 'th', s: '/ð/', w: 'these', e: '🔢', p: ['th', 'ese'] },
        { l: 'th', s: '/ð/', w: 'those', e: '🔣', p: ['th', 'ose'] },
        { l: 'th', s: '/ð/', w: 'there', e: '📍', p: ['th', 'ere'] },
        { l: 'th', s: '/ð/', w: 'mother', e: '👩', p: ['mo', 'th', 'er'] },
      ]},
  ...
  {
    id: 'g1-2', title: 'G1–2', cn: 'L/R 连缀 · 长元音 · 词尾 · 末尾混音', color: 'pink', icon: 'ti-puzzle',
    desc: 'L/R 连缀、长元音 a/e/i、词尾 -le / y，以及词尾 L 混音 ld/lt/lk/lp',
    units: [
      ...
      { id: 'ending-l-blends', title: 'Ending L Blends', cn: '词尾 L 连缀 ld/lt/lk/lp', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'ld', s: '/ld/', w: 'old', e: '👴', p: ['o', 'ld'] },
        { l: 'ld', s: '/ld/', w: 'gold', e: '🥇', p: ['go', 'ld'] },
        { l: 'ld', s: '/ld/', w: 'cold', e: '🥶', p: ['co', 'ld'] },
        { l: 'lt', s: '/lt/', w: 'belt', e: '🔧', p: ['be', 'lt'] },
        { l: 'lt', s: '/lt/', w: 'melt', e: '🧊', p: ['me', 'lt'] },
        { l: 'lk', s: '/lk/', w: 'milk', e: '🥛', p: ['mi', 'lk'] },
        { l: 'lk', s: '/lk/', w: 'silk', e: '🧵', p: ['si', 'lk'] },
        { l: 'lp', s: '/lp/', w: 'help', e: '��', p: ['he', 'lp'] },
      ]},
  ...
  {
    id: 'g2', title: 'G2', cn: '长元音进阶 · R控制 · 双元音 · 复合词', color: 'amber', icon: 'ti-star',
    desc: 'y/igh、长 o/u/ui/ue、oo、r 控制元音、ou/ow 双读音、oi/oy、aw/ew、复合词、缩写词',
    units: [
      ...
      { id: 'long-u-ui-ue', title: 'Long u (ui / ue)', cn: '长 u — ui / ue', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'ue', s: '/uː/', w: 'blue', e: '🔵', p: ['bl', 'ue'] },
        { l: 'ue', s: '/uː/', w: 'glue', e: '🔗', p: ['gl', 'ue'] },
        { l: 'ue', s: '/uː/', w: 'true', e: '✅', p: ['tr', 'ue'] },
        { l: 'ui', s: '/uː/', w: 'fruit', e: '🍇', p: ['fr', 'ui', 't'] },
        { l: 'ui', s: '/uː/', w: 'juice', e: '🥤', p: ['j', 'ui', 'ce'] },
        { l: 'ui', s: '/uː/', w: 'suit', e: '🤵', p: ['s', 'ui', 't'] },
      ]},
      ...
      { id: 'ou-ow', title: 'ou / ow (双读音)', cn: 'ou/ow — /aʊ/ vs /oʊ/', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'ou', s: '/aʊ/', w: 'cloud', e: '☁️', p: ['cl', 'ou', 'd'] },
        { l: 'ou', s: '/aʊ/', w: 'mouse', e: '🐭', p: ['m', 'ou', 'se'] },
        { l: 'ou', s: '/aʊ/', w: 'house', e: '🏠', p: ['h', 'ou', 'se'] },
        { l: 'ow', s: '/aʊ/', w: 'cow', e: '🐄', p: ['c', 'ow'] },
        { l: 'ow', s: '/aʊ/', w: 'owl', e: '🦉', p: ['ow', 'l'] },
        { l: 'ow', s: '/oʊ/', w: 'snow', e: '❄️', p: ['sn', 'ow'] },
        { l: 'ow', s: '/oʊ/', w: 'bow', e: '🎀', p: ['b', 'ow'] },
        { l: 'ow', s: '/oʊ/', w: 'crow', e: '🐦‍⬛', p: ['cr', 'ow'] },
      ]},
      { id: 'oi-oy', title: 'oi / oy', cn: '双元音 oi / oy /ɔɪ/', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'oi', s: '/ɔɪ/', w: 'coin', e: '🪙', p: ['c', 'oi', 'n'] },
        { l: 'oi', s: '/ɔɪ/', w: 'oil', e: '🛢️', p: ['oi', 'l'] },
        { l: 'oi', s: '/ɔɪ/', w: 'point', e: '☝️', p: ['p', 'oi', 'nt'] },
        { l: 'oy', s: '/ɔɪ/', w: 'toy', e: '🧸', p: ['t', 'oy'] },
        { l: 'oy', s: '/ɔɪ/', w: 'boy', e: '👦', p: ['b', 'oy'] },
        { l: 'oy', s: '/ɔɪ/', w: 'joy', e: '😄', p: ['j', 'oy'] },
      ]},
      { id: 'aw-ew', title: 'aw / ew', cn: 'aw / ew 音', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        ...
        { l: 'aw', s: '/ɔː/', w: 'yawn', e: '🥱', p: ['y', 'aw', 'n'] },
        { l: 'ew', s: '/uː/', w: 'screw', e: '🔩', p: ['scr', 'ew'] },
        { l: 'ew', s: '/uː/', w: 'dew', e: '💧', p: ['d', 'ew'] },
        { l: 'ew', s: '/uː/', w: 'flew', e: '✈️', p: ['fl', 'ew'] },
        { l: 'ew', s: '/uː/', w: 'drew', e: '✏️', p: ['dr', 'ew'] },
      ]},
      { id: 'compound-words', title: 'Compound Words', cn: '复合词', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: 'sun+flower', s: '/ˈsʌnflaʊər/', w: 'sunflower', e: '🌻', p: ['sun', 'flow', 'er'] },
        { l: 'rain+bow', s: '/ˈreɪnboʊ/', w: 'rainbow', e: '🌈', p: ['rain', 'bow'] },
        { l: 'butter+fly', s: '/ˈbʌtərflaɪ/', w: 'butterfly', e: '🦋', p: ['but', 'ter', 'fly'] },
        { l: 'snow+man', s: '/ˈsnoʊmæn/', w: 'snowman', e: '⛄', p: ['snow', 'man'] },
        { l: 'basket+ball', s: '/ˈbæskɪtbɔːl/', w: 'basketball', e: '🏀', p: ['bas', 'ket', 'ball'] },
        { l: 'water+melon', s: '/ˈwɔːtərmɛlən/', w: 'watermelon', e: '🍉', p: ['wa', 'ter', 'mel', 'on'] },
        { l: 'birth+day', s: '/ˈbɜːrθdeɪ/', w: 'birthday', e: '🎂', p: ['birth', 'day'] },
        { l: 'book+worm', s: '/ˈbʊkwɜːrm/', w: 'bookworm', e: '📚', p: ['book', 'worm'] },
      ]},
      { id: 'contractions', title: 'Contractions', cn: '缩写词', acts: ['flashcard', 'listen', 'match', 'spell'], items: [
        { l: "I'm", s: '/aɪm/', w: "I'm", e: '🙋', p: ["I", "'m"] },
        { l: "it's", s: '/ɪts/', w: "it's", e: '📎', p: ["it", "'s"] },
        { l: "she's", s: '/ʃiːz/', w: "she's", e: '👩', p: ["she", "'s"] },
        { l: "they're", s: '/ðeər/', w: "they're", e: '👥', p: ["they", "'re"] },
        { l: "don't", s: '/doʊnt/', w: "don't", e: '🚫', p: ["do", "n't"] },
        { l: "can't", s: '/kænt/', w: "can't", e: '❌', p: ["ca", "n't"] },
        { l: "won't", s: '/woʊnt/', w: "won't", e: '🙅', p: ["wo", "n't"] },
        { l: "haven't", s: '/hævnt/', w: "haven't", e: '🤷', p: ["have", "n't"] },
      ]},
    ],
  },
];
